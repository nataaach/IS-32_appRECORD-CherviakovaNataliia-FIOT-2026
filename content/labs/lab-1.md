...
* **Мета:** полегшення доступу через розробку інтуїтивно зрозумілого інтерфейсу для замовлення засобів у кілька кліків та забезпечення повної інформаційної доступності шляхом надання вичерпних даних про склад, сертифікацію та застосування продуктів у зручному цифровому форматі.
