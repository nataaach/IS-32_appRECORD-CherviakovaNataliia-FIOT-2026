...
* **Місце розташування:**
    ...
    * **Звітний HTML-документ (Жива сторінка):** https://nataaach.github.io/IS-32-Cherviakova-Natalia-Labs/
...
![Use-case діаграма «Glow & Care»](/assets/home/labs/lab-1/diagram.png)
**ER-діаграма:** Відображає логічну структуру бази даних (Товари, Категорії, Замовлення, Користувач).
![ER діаграма «Glow & Care»](/assets/home/labs/lab-1/diagram2.png)
---
---
## ВИСНОВКИ
